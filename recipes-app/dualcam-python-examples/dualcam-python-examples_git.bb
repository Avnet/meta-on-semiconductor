...
SRC_URI = "git://github.com/AlbertaBeef/avnet_dualcam_python_examples;protocol=https;branch=2022.2"
SRCREV = "${AUTOREV}"
...
do_install() {
	...
	install -m 0755 ${S}/avnet_dualcam_anaglyph.py ${HOMEPATH}/avnet_dualcam_anaglyph.py
	install -m 0755 ${S}/avnet_dualcam_passthrough.py ${HOMEPATH}/avnet_dualcam_passthrough.py
}
